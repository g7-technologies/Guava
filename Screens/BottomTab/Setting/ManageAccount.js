...
import { GetUserRecordAsync, ManageAccount, ReturnUserRecordAsync } from '../../Services/Authentication';
  ...
  const UpdateProfile=async()=>{
    try{
      if(IsLoading){
        ...
        var CheckStatus=await ManageAccount(UserID,UserName,Name,Bio,UserDOB,imageBase64)
    ...
    return (
     ...
     <View style={{marginTop:25}}/>}
        <CommonHeader navigation={navigation} Name={'Manage Account'}/>
     ...
     <Text style={{fontSize:10,textAlign:'center',marginTop:8}}>Gava Profile Image</Text>
        </View>
        <View style={{margin:20}}>
          ...
          <View style={{height:windowHeight/15,backgroundColor:'#e5e5ea',borderRadius:25,flexDirection:'row',alignItems:'center',marginVertical:5}}>
            ...
            <TextInput style={{marginLeft:10,flex:1,marginRight:20}}  placeholder='James Cadby'  onChangeText={(e)=>SetName(e)} defaultValue={Name} placeholderTextColor={'#8e8e93'} />
          </View>
          <View style={{height:windowHeight/15,backgroundColor:'#e5e5ea',borderRadius:25,flexDirection:'row',alignItems:'center',marginVertical:5}}>
            <View style={{backgroundColor:'#3A3A3C',width:50,height:windowHeight/15,borderRadius:30,alignItems:'center',justifyContent:'center'}}>
            <AntDesign name="exclamationcircleo" size={24} color="#fff" />
            </View>
            <TextInput style={{marginLeft:10,flex:1,marginRight:20}}  placeholder='About You'  onChangeText={(e)=>SetBio(e)} defaultValue={Bio} placeholderTextColor={'#8e8e93'} />
          </View>
          {/* <View style={{height:windowHeight/15,backgroundColor:'#e5e5ea',borderRadius:25,flexDirection:'row',alignItems:'center',marginVertical:5}}>
            <View style={{backgroundColor:'#3A3A3C',width:50,height:windowHeight/15,borderRadius:30,alignItems:'center',justifyContent:'center'}}>
              <EmailIcon/>
